defmodule TheAdventuringDayWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TheAdventuringDayWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TheAdventuringDayWeb.Gettext, "errors", msg, opts)
    end
  end
