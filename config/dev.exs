...
config :the_adventuring_day, TheAdventuringDayWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "aOBnH+6bGRBukPBrg8/KEOeYCp12sjErNqHFFvc92KpKONEY7DQkQzqjz1ORg208",
  watchers: [
...
config :the_adventuring_day, TheAdventuringDayWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/the_adventuring_day_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :the_adventuring_day, dev_routes: true
